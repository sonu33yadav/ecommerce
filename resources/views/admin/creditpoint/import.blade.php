...
@section('content')
    <div class="side-app">
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin.product.list')}}">@lang('credit_point')</a></li>
                <li class="breadcrumb-item active" aria-current="page">@lang('import')</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <form method="post" class="card" action="{{route('admin.product.importExcel')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">
                        <h3 class="card-title">@lang('import_credit_point')</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
