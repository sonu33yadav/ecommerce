                ...
                <tr>
                    <td>
                        ...
                        <div style="text-align: center; width: 100%">
                            <img src="{{asset('images/template/verify.png')}}" style="width: 200px; margin-top: 10px; margin-bottom: 10px">
                        </div>
                        <h1 style="font-size: 30px; text-align: center;color: black; margin-bottom: 15px">@lang('welcome')!</h1>
                        <p style="font-size:14px; text-align: center;color: black; margin-bottom: 0">@lang('we_are_happy_you_signed')</p>
                        <p style="font-size:14px; text-align: center;color: black; margin-bottom: 0">@lang('to_start_exploring')</p>
