  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#736cc7', '#ff5c75', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#f1c40f', '#24CBE5', '#64E572' , '#736cc7', '#ff5c75' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	colors: ['#736cc7', '#ff5c75', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
